...
// Debug script for the current qualification
async function debugCurrentQualification() {
  try {
    console.log('🔍 Debugging current qualification...');
    ...
    const qualificationId = 'cbf74422-52ed-4c82-a9a5-958088828fb5';
