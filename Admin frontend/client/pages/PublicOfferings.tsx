                    ...
                    <section>
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 max-w-4xl mx-auto">
                        {filteredOfferings.filter(o => getPeoTvSubCategoryGroup(o) === 'peocharges').map((offering) => {
                          ...
                          return (
                            <Card key={offering.id} className="hover:shadow-lg hover:-translate-y-1 transition-all duration-300 overflow-hidden bg-white border-0 shadow-md shadow-orange-500/10 rounded-xl">
                              ...
                              <div className="p-3 bg-white">
                                <div className="flex items-start gap-4">
                                  ...
                                  <div className="flex flex-col items-center gap-2">
                                    ...
                                    <Badge className="bg-gradient-to-r from-orange-500 to-red-600 text-white border-0 text-xs font-bold px-1.5 py-0.5 rounded-full">
                                      PEO-TV
                                    </Badge>
                                  </div>
                                        ...
                                        <div className="space-y-0.5">
                                          {includes.split(',').map((item: string, index: number) => (
                                            <div key={index} className="flex items-center gap-1.5">
                                              ...
                                              <span className="text-gray-700 text-xs">{item.trim()}</span>
                                            </div>
                                          ))}
                                        </div>
                                      </div>
                                  ...
                                  <div className="flex flex-col items-center justify-center">
                                    <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-blue-700 rounded-full flex flex-col items-center justify-center text-white shadow-md">
