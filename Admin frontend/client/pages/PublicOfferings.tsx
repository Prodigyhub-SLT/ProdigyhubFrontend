                    ...
                    <section>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
                        {filteredOfferings.filter(o => getPeoTvSubCategoryGroup(o) === 'peopackages').map((offering) => {
                          ...
                          return (
                            <Card key={offering.id} className="hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 overflow-hidden bg-white border-0 shadow-xl rounded-2xl max-w-xl mx-auto px-6 py-8 min-h-[520px]">
                              {/* Title */}
                              ...
                              <div className="flex justify-center mb-6">
                                <div className={`w-56 h-56 bg-gradient-to-br ${colors.gradient} rounded-full flex flex-col items-center justify-center relative shadow-lg`}>
                          ...
                          <Card key={offering.id} className="hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 overflow-hidden bg-white border-0 shadow-xl shadow-orange-500/10 rounded-2xl">
                            ...
                            <div className="p-3 bg-white">
                              <div className="flex items-center gap-4 h-44">
                                ...
                                <div className="flex-1 space-y-3 pl-40">
                                  <p className="text-gray-700 text-sm font-bold -mt-2">{offering.description || 'Applicable for existing Fibre or Megaline connections'}</p>
                                  {features && (
                                    <div>
                                      <h4 className="text-sm font-semibold text-gray-800 mb-1">Key Features</h4>
                                      <div className="bg-gray-100 border border-gray-300 rounded p-2 w-fit">
                            ...
                            <div className="bg-gradient-to-r from-orange-500 to-red-600 text-white p-3">
                              <div className="flex gap-3">
                                <Button variant="ghost" size="sm" onClick={() => handleViewSpec(offering)} className="flex-1 text-white hover:bg-orange-600 hover:text-white transition-all duration-200 rounded-lg py-2 font-medium border border-white/20">View Details</Button>
                                <Button variant="ghost" size="sm" onClick={() => handleViewSpec(offering)} className="flex-1 text-white hover:bg-orange-600 hover:text-white transition-all duration-200 rounded-lg py-2 font-medium border border-white/20">View Channels</Button>
                              </div>
                            </div>
                          </Card>
                        );
