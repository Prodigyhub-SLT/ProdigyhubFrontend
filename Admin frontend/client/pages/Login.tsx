      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-blue-800 rounded-lg p-8 space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* Forgot Password and Sign In Button Row */}
          ...
          <div className="space-y-4">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-blue-800 px-2 text-white">Or Sign In With</span>
              </div>
            </div>
            ...
            <div className="flex space-x-4">
              <Button
                ...
                className="flex-1 bg-white text-gray-700 hover:bg-gray-50 border-gray-300 h-12 rounded-lg"
              >
                {isGoogleLoading ? (
                  <>
              ...
              <Button
                type="button"
                variant="outline"
                className="flex-1 bg-blue-600 text-white hover:bg-blue-700 border-blue-600 h-12 rounded-lg"
              >
