    ...
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="bg-white rounded-lg p-8 space-y-6 shadow-lg">
          ...
          <Button type="button" variant="outline" onClick={handleGoogleSignUp} disabled={isGoogleLoading} className="w-full bg-white text-gray-700 hover:bg-gray-50 border-gray-300 h-12 rounded-lg">
