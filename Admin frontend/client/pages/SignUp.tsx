...
export default function SignUp() {
  ...
  const validatePhone = (phone: string): { isValid: boolean; message: string } => {
    ...
    const validOperators = ['0','1','2','5','6','7','8'];
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="bg-white rounded-lg p-8 space-y-6 shadow-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* FIXED: Terms & Conditions Checkbox with visible tick */}
            <div className="flex items-center space-x-3">
              <Checkbox 
                id="agreeToTerms" 
                checked={agreeToTerms} 
                onCheckedChange={(checked) => setAgreeToTerms(checked as boolean)}
                className="data-[state=checked]:bg-blue-600 data-[state=checked]:border-blue-600 border-gray-400 rounded focus:ring-blue-500"
              />
              <Label htmlFor="agreeToTerms" className="text-gray-700 text-sm leading-relaxed cursor-pointer">
